<?php
    ...
    $poster_path = '../student/uploads/posters/' . $poster_file;
...
<head>
    ...
    <title>Event Poster - Counselor Review</title>
...
<body>
    <div class="header">
        <h1>
            ...
            Event Poster Review - Counselor Portal
        </h1>
        <a href="od_approvals.php" class="back-btn">
            <span class="material-symbols-outlined">arrow_back</span>
            Back to OD Approvals
        </a>
    </div>

    <div class="poster-container">
        <div class="counselor-note">
            <strong>📋 Counselor Review:</strong> Please review this event poster to help make an informed approval decision for the student's OD request.
        </div>
        ...
        <div class="poster-actions">
            ...
            <a href="od_approvals.php" class="action-btn approve">
                <span class="material-symbols-outlined">approval</span>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #dee2e6; color: #6c757d; font-size: 14px;">
            ...
            <div style="text-align: left; margin: 10px 0;">
                <strong>Filename:</strong>                                           <?php echo htmlspecialchars($poster_file); ?><br>
    ...
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'Escape') {
                window.location.href = 'od_approvals.php';
            }

<?php
    ...
    $student_events_sql    = "SELECT COUNT(DISTINCT event_type) as count FROM student_event_register WHERE event_type IS NOT NULL AND event_type != '' AND YEAR(start_date) = $current_year";
    ...
    $student_participation_sql    = "SELECT COUNT(*) as count FROM student_event_register WHERE YEAR(start_date) = $current_year";
    ...
    if ($is_comparison_mode) {
        ...
        $compare_events_sql    = "SELECT COUNT(DISTINCT event_type) as count FROM student_event_register WHERE event_type IS NOT NULL AND event_type != '' AND YEAR(start_date) = $compare_year";
        ...
        $compare_parts_sql            = "SELECT COUNT(*) as count FROM student_event_register WHERE YEAR(start_date) = $compare_year";

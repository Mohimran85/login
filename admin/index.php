      ...
      <aside id="sidebar">
        <div class="sidebar-title">
          ...
          <ul class="sidebar-list">
            ...
            <li class="sidebar-list-item">
              <span class="material-symbols-outlined"></span>bar_chart</span>
          ...
          <div class="charts-card enhanced-category-card">
            ...
            <div class="category-summary">
              <div class="summary-stats">
                ...
                <div class="summary-item">
                  <span class="summary-value"><?php
                                                  // Calculate average success rate for competitive events only
                                                  $competitive_categories = array_filter($category_analytics, function ($cat) {
                                                      return isset($cat['is_competitive']) && $cat['is_competitive'];
                                                  });
                                              $avg_success = count($competitive_categories) > 0 ? array_sum(array_column($competitive_categories, 'success_rate')) / count($competitive_categories) : 0;
                ...
                <div class="indicator-item best-performance">
                  ...
                  <div class="indicator-content">
                    ...
                    <span class="indicator-value"><?php
                                                      $best_category = '';
                                                      $best_rate     = 0;
                                                      // Only consider competitive events for best performance
                                                      foreach ($category_analytics as $name => $data) {
                                                          if (isset($data['is_competitive']) && $data['is_competitive'] && $data['success_rate'] > $best_rate) {
                                                  ...
                                                  ?></span>
                    <span class="indicator-desc"><?php echo $best_rate > 0 ? $best_rate . '% success rate' : 'No competitive event data'; ?></span>
                  </div>
                </div>
              </div>
            </div>

...
<body>
                                    ...
                                    <select id="current_year" name="current_year" required>
                                        ...
                                        <?php
                                            ...
                                            for ($i = 0; $i < 10; $i++) {
                                                ...
                                                $selected      = ($participant['current_year'] === $academic_year) ? 'selected' : '';
    ...
    <script>
        ...
        // Hide/show achievement section based on event type
        const eventTypeSelect = document.getElementById('event_type');
        const achievementSection = document.querySelector('.form-section:has(#prize)');

        function toggleAchievementSection() {
            if (eventTypeSelect && achievementSection) {
                const eventType = eventTypeSelect.value;
                // Hide achievement section for Workshop, Seminar, Webinar, Training
                const noPrizeEvents = ['Workshop', 'Seminar', 'Webinar', 'Training'];
        ...
        if (eventTypeSelect) {
            eventTypeSelect.addEventListener('change', toggleAchievementSection);
            // Check on page load
            toggleAchievementSection();
        }

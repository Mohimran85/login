...
<div class="grid-container">
    ...
    <div class="registration-container">
      ...
      <div class="form-section">
        ...
        <div class="parent">
          ...
          <div class="item">
            <label for="eventDate">Event Date:<span class="required-asterisk">*</span></label>
          ...
          <div class="item">
            ...
            <div class="form-field-helper">Enter the number of days for the event</div>
          </div>
          <div class="item">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-fill number of days - defaults to 1
        const eventDateInput = document.getElementById('eventDate');
        const noOfDaysInput = document.getElementById('noOfDays');

        // Set default value when event date is selected
        if (eventDateInput && noOfDaysInput) {
            ...
            // Set default on page load if event date is pre-filled
            if (eventDateInput.value) {
                noOfDaysInput.value = 1;
            }
        }
